    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/yuokiTani/entities/cannon-mk1-sheet.png",
                        priority = "high",
                        width = 128,
                        height = 128,
                        line_length = 8,
...
-- 		{
-- 		    {
-- 			filename = "__RampantArsenalFork_Firestorm__/graphics/entities/cannon-mk1-sheet.png",
-- 			priority = "high",
-- 			width = 128,
-- 			height = 128,
-- 			line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/yuokiTani/entities/shotgun-turret-sheet.png",
                        priority = "high",
                        width = 90,
                        height = 90,
                        line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/yuokiTani/entities/cannon-mk2-sheet.png",
                        priority = "high",
                        width = 128,
                        height = 128,
                        line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/yuokiTani/entities/cannon-mk2-place.png",
                        priority = "high",
                        width = 128,
                        height = 128,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/yuokiTani/entities/cr-sheet.png",
                        priority = "high",
                        width = 256,
                        height = 256,
                        line_length = 8,
...
function cannons.enable()
    local cannonAttributes = {
        name = "cannon",
        icon = "__RampantArsenalFork_Firestorm__/graphics/icons/cannonTurret.png",
        miningTime = 5,
        health = 2500,
    ...
    local rapidCannonAttributes = {
        name = "rapid-cannon",
        icon = "__RampantArsenalFork_Firestorm__/graphics/icons/rapidCannonTurret.png",
        miningTime = 5,
        health = 2000,
    ...
    local advFlamethrowerAttributes = {
        ...
        icon = "__RampantArsenalFork_Firestorm__/graphics/icons/suppressionCannonTurret.png",
        miningTime = 5,
        health = 3000,
    ...
    local shotgunAttributes = {
        name = "shotgun",
        icon = "__RampantArsenalFork_Firestorm__/graphics/icons/shotgunTurret.png",
        miningTime = 1,
        health = 1000,
        hasBaseDirection = true,
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        local incendiaryCannonShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/incendiary-cannon-shell.png",
        ...
        local heCannonShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/he-cannon-shell.png",
        ...
        local bioCannonShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/bio-cannon-shell.png",
