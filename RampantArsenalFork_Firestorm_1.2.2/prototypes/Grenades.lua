...
function grenades.enable()
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        local incendiaryGrenade = makeCapsule(
            {
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/incendiary-grenade.png",
        ...
        local heGrenade = makeCapsule(
            {
                name = "he-grenade",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/he-grenade.png",
        ...
        local bioGrenade = makeCapsule(
            {
                name = "bio-grenade",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/bio-grenade.png",
        ...
        local toxicCapsule = makeCapsule(
            {
                name = "toxic",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/toxic-capsule.png",
    ...
    local repairCapsule = makeCapsule(
        {
            name = "repair",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/repair-capsule.png",
    ...
    local paralysisCapsule = makeCapsule(
        {
            name = "paralysis",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/paralysis-capsule.png",
    ...
    local healingCapsule = makeCapsule(
        {
            name = "healing",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/healing-capsule.png",
    ...
    local speedCapsule = makeCapsule(
        {
            name = "speed",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/speed-capsule.png",
