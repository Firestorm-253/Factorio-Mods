...
function vehicles.enable()
    ...
    local advTank = makeTank({
            ...
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/advanced-tank.png",
            health = 4500,
            consumption = "4.0MW",
            weight = 30000,
            inventorySize = 100,
    ...
    local nuclearTank = makeTank({
            ...
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/nuclear-tank.png",
    ...
    local advCar = makeCar({
            ...
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/advanced-car.png",
            immuneToTrees = true,
            health = 1200,
            friction = 0.02,
    ...
    local nuclearCar = makeCar({
            ...
            weight = 2500,
            inventorySize = 200,
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/nuclear-car.png",
    ...
    local nuclearTrain = makeTrain({
            ...
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/nuclear-locomotive.png",
