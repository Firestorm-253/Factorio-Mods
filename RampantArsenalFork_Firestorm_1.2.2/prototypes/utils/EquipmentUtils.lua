    ...
    data:extend({
            {
                type = "item",
                name = name,
                icon = attributes.icon or "__base__/graphics/icons/fission-reactor-equipment.png",
                icon_size = 32,
                place_as_equipment_result = name,
                flags = {},
                subgroup = "equipment",
            ...
            },
            {
                ...
                sprite =
                    {
                        filename = attributes.picture or "__base__/graphics/equipment/fission-reactor-equipment.png",
                        width = 128,
                        height = 128,
                        priority = "medium"
                    },
