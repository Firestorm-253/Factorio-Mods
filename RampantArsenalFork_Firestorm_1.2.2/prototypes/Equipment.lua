...
function Equipment.enable()
    ...
    local powerArmor = makeArmor({
            ...
            inventoryBonus = 60,
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/power-armor-mk3.png",
    ...
    local shieldMk3 = makeShield({
            name = "mk3",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/energy-shield-mk3-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/energy-shield-mk3-equipment.png",
    ...
    local batteryMk3 = makeBattery({
            name = "mk3",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/battery-mk3-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/battery-mk3-equipment.png",
    ...
    local generatorMk3 = makeGenerator({
            name = "mk3",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/generator-mk3-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/generator-mk3-equipment.png",
    ...
    local generatorNuclear = makeGenerator({
            name = "nuclear",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/generator-nuclear-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/generator-nuclear-equipment.png",
    ...
    local passiveShotgun = makePassiveDefense(
        {
            name = "shotgun",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/personal-shotgun-defense-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/personal-shotgun-defense-equipment.png",
    ...
    local passiveCannon = makePassiveDefense(
        {
            name = "cannon",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/personal-cannon-defense-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/personal-cannon-defense-equipment.png",
    ...
    local passiveLightning = makePassiveDefense(
        {
            name = "lightning",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/personal-lightning-defense-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/personal-lightning-defense-equipment.png",
    ...
    local passiveBullets = makePassiveDefense(
        {
            name = "bullets",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/personal-bullet-defense-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/personal-bullet-defense-equipment.png",
    ...
    local passiveSlow = makePassiveDefense(
        {
            name = "slow",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/personal-slow-defense-equipment.png",
            picture = "__RampantArsenalFork_Firestorm__/graphics/equipment/personal-slow-defense-equipment.png",
