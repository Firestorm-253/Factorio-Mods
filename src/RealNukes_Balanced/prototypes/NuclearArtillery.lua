...
local nuke = require("__RealNukes_Balanced__/scripts/Nuke")
...
makeNuclearArtilleryShellAmmo(
	...
	"crafting",
	"atomic-bomb",
	"__RealNukes_Balanced__/graphics/icons/nuclear-artillery-shell.png"
)
...
makeNuclearArtilleryShellAmmo(
	...
	"cryogenics",
	"fusion-reactor",
	"__RealNukes_Balanced__/graphics/icons/fusion-artillery-shell.png"
)
