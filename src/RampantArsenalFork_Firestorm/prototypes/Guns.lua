    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/yuokiTani/entities/gluegun_anim.png",
                        priority = "high",
                        width = 80,
                        height = 72,
                        line_length = 16,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork_Firestorm__/graphics/entities/rifle-turret.png",
                        priority = "high",
                        width = 34,
                        height = 49,
                        line_length = 8,
...
function guns.enable()
    ...
    local mortar = makeGun(
        {
            name = "mortar",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/mortar.png",
            iconSize = 64,
            order = "e[mortar]-b"
        },
        {
    ...
    local rocketLauncher = makeGun(
        {
            ...
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/upgraded-rocket-launcher.png",
    ...
    local minigun = makeGun(
        {
            name = "minigun",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/minigun.png",
            iconSize = 64,
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        ...
        local uraniumShotgunShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/uranium-shotgun-shell.png",
        ...
        local incendiaryShotgunShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/incendiary-shotgun-shell.png",
        ...
        local incendiaryMagazineAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/incendiary-rounds-magazine.png",
        ...
        local heShotgunShellAmmo = makeAmmo({
                name = "he-shotgun",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/he-shotgun-shell.png",
        ...
        -- end
            = makeAmmo({
                    name = "he-magazine",
                    icon = "__RampantArsenalFork_Firestorm__/graphics/icons/he-rounds-magazine.png",
        ...
        local bioShotgunShellAmmo = makeAmmo({
                name = "bio-shotgun",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/bio-shotgun-shell.png",
        ...
        local bioMagazineAmmo = makeAmmo({
                name = "bio-magazine",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/bio-rounds-magazine.png",
    ...
    makeRecipe({
            name = mortar,
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/recipe-mortar.png",
            enabled = false,
            ingredients = {
    ...
    makeRecipe({
            name = minigun,
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/recipe-minigun.png",
            enabled = false,
            ingredients = {
    ...
    makeRecipe({
            name = rocketLauncher,
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/recipe-upgraded-rocket-launcher.png",
    ...
    local gunTurretAttributes = {
        name = "gun",
        icon = "__RampantArsenalFork_Firestorm__/graphics/icons/gluegun-icon.png",
    ...
    if settings.startup["rampant-arsenal-enableRifleTurret"].value then
        local rifleTurretAttributes = {
            name = "rifle",
            icon = "__RampantArsenalFork_Firestorm__/graphics/icons/rifle-turret.png",
            miningTime = 1,
            health = 200,
