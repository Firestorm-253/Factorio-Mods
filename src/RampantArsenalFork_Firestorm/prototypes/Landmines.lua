...
function landmines.enable()
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        local nuclearLandmine = makeLandmine(
            {
                name = "nuclear",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/nuclear-landmine.png",
        ...
        local incendiaryLandmine = makeLandmine(
            {
                name = "incendiary",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/incendiary-landmine.png",
        ...
        local bioLandmine = makeLandmine(
            {
                name = "bio",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/bio-landmine.png",
        ...
        local heLandmine = makeLandmine(
            {
                name = "he",
                icon = "__RampantArsenalFork_Firestorm__/graphics/icons/he-landmine.png",
